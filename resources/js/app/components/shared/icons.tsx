...
export function ShieldIcon(props: IconProps) {
  return (
    <div className="flex size-[40px] items-center justify-center rounded-full bg-primary">
...
export function ShieldIconSmall(props: IconProps) {
  return (
    <svg width="16" height="22" viewBox="0 0 16 22" fill="none" {...props}>
      <path d="M8 0L0 3v7c0 5.55 3.84 10.74 8 12 4.16-1.26 8-6.45 8-12V3L8 0zm0 2.18L14 4.3v5.7c0 4.55-2.77 8.73-6 9.94V2.18z" fill="currentColor" />
    </svg>
  );
}
...
export function UserIcon(props: IconProps) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" {...props}>
      <path d="M8 8C9.933 8 11.5 6.433 11.5 4.5S9.933 1 8 1 4.5 2.567 4.5 4.5 6.067 8 8 8zm0 2c-3.315 0-6 1.79-6 4v1h12v-1c0-2.21-2.685-4-6-4z" fill="currentColor" />
    </svg>
  );
}
...
export function LockIcon(props: IconProps) {
  return (
    <svg width="16" height="21" viewBox="0 0 16 21" fill="none" {...props}>
      <path d="M13 7h-1V5c0-2.76-2.24-5-5-5S2 2.24 2 5v2H1c-1.1 0-2 .9-2 2v9c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zM8 15.17c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM10.5 7h-5V5c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5v2z" fill="currentColor" />
    </svg>
  );
}
...
export function KeyIcon(props: IconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M21 4l-2 2m-4-2l-6 6m-2.5 2.5A3.5 3.5 0 102 13.5a3.5 3.5 0 006.5 2.5L12 12l2 2 2-2-2-2 2-2-2-2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M15 9l2-2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function DashboardQueryIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" className="text-primary">
      <path d="M9 1C4.58 1 1 4.58 1 9s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm1-9H8v5h2V6zm0 6H8v2h2v-2z" fill="currentColor" />
    </svg>
  );
}
...
export function DashboardBlockIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" className="text-danger">
      <path d="M9 1L2 4v5c0 4.5 3 8.5 7 9 4-.5 7-4.5 7-9V4L9 1zm0 2.5L14 5.7v3.3c0 3.3-2.1 6.4-5 7.3V3.5z" fill="currentColor" />
    </svg>
  );
}
...
export function ParentalControlIcon(props: IconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" {...props}>
      <circle cx="10" cy="10" r="8" stroke="currentColor" strokeWidth="1.5" fill="none" />
