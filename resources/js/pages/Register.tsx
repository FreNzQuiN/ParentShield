...
export default function Register() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    else if (password.length < 8) clientErrors.password = 'Password must be at least 8 characters.';
    if (password !== passwordConfirmation) clientErrors.password_confirmation = 'Passwords do not match.';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            >
              {loading ? <Loading size="sm" message="Creating account..." /> : 'Create Account'}
            </button>
          </form>
        </div>
